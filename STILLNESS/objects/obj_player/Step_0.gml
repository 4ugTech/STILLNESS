if(obj_game_handler.camera_state != 1)
{
	...
	else if(keyboard_check(ord("D")) && !place_meeting(x + current_move_speed, y, [tilemap_lab1, tilemap_hopsital, tilemap_walls]))
	{	
		moving_right = true
		moving_left = false
		hspeed = current_move_speed	
	}
	else if(keyboard_check(ord("A")) && !place_meeting(x - current_move_speed, y, [tilemap_lab1, tilemap_hopsital, tilemap_walls]))
	{
		moving_left = true
		moving_right = false
		hspeed = -current_move_speed		
	...
	else if(keyboard_check(ord("W")) && !place_meeting(x, y - current_move_speed, [tilemap_lab1, tilemap_hopsital, tilemap_walls]))
	{
		vspeed = -current_move_speed
	}
	else if(keyboard_check(ord("S")) && !place_meeting(x, y + current_move_speed, [tilemap_lab1, tilemap_hopsital, tilemap_walls]))
	{
		vspeed = current_move_speed
	}
	else
